...
class EndFaceCliTests(unittest.TestCase):
    ...
    def test_run_wraps_existing_core_measurements(self) -> None:
        with tempfile.TemporaryDirectory() as temporary:
            ...
            measurements = {"transform.scale": 1.0, "Phi100.radius_ref_px": 10.0}
            with patch("algorithms.end_face.main.core.build_reference_model", return_value=model), patch(
                "algorithms.end_face.main.core.detect_measurements", return_value=(measurements, "core-method")
            ):
        ...
        self.assertEqual("core-method", payload["result"]["shiftMethod"])
    ...
    def test_cli_writes_json_file(self) -> None:
        with tempfile.TemporaryDirectory() as temporary:
            ...
            with patch("algorithms.end_face.main.run", return_value={
                "schemaVersion": "a-end-face-result/1",
            ...
            self.assertEqual("a-end-face-result/1", json.loads(output.read_text(encoding="utf-8"))["schemaVersion"])
