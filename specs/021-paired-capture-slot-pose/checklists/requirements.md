...
- 2026-08-17 completed pixel-review increment revalidated through FR-104 and SC-044: 145/147 provide wall/endpoint residual evidence only; missing independent outer-circle truth keeps final pose accuracy blocked. The contrast-only alternative remains default-off, non-authoritative and unable to promote pose or PLC.
- 2026-08-17 outer-circle truth-evaluation increment revalidated through FR-120 and SC-052: structural `poseAngleReady` is separated from formal circle usability. Existing 120-degree coverage and explicit residual/stability hard gates precede final angle/MVP evaluation; 145's approximately 30-degree arc must remain NOT_EVALUATED rather than drive threshold relaxation.
